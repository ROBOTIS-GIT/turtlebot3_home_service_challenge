...
class ArUcoParking(Node):
    ...
    def __init__(self):
        ...
        self.pub_is_completed_parking = self.create_publisher(
            Bool,
        ...
        self.ParkingSequence = Enum(
            'ParkingSequence',
            'waiting search_parking_lot align_direction move_nearby_parking_lot \
                parking retry stop initialization'
        )
    ...
    def pub_parking_complete_msg(self):
        msg = Bool()
        msg.data = True
        self.pub_is_completed_parking.publish(msg)
